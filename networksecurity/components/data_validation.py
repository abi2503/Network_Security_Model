...
class DataValidation:
    ...
    @staticmethod  #This is used to make the method static so that it can be used without creating an instance of the class
    ...
    #Compares the base and current dataframe and checks for data drift. Also checks the statistical values of the data
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            #reading the data from the train and test file paths
